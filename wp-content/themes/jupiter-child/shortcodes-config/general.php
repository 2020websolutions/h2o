...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "param_name" => "el_link",
            "value" => "",
            "description" => __("If you wish for the custom box to link to elsewhere, then use this field to add a hyperlink.", "mk_framework")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "mk_framework"),
...
vc_map(array(
    "name" => __("Select Menu", "mk_framework"),
    "base" => "select_menu",
    "category" => __('General', 'mk_framework'),
    'icon' => 'icon-mk-custom-list vc_mk_element-icon',
    'description' => __( 'Custom select menu', 'mk_framework' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Select Title", "mk_framework"),
            "param_name" => "title",
            "value" => "",
            "description" => __("", "mk_framework")
        ),
        array(
            "type" => "colorpicker",
            "heading" => __("Select Color", "mk_framework"),
