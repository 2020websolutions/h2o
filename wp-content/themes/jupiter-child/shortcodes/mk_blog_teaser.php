        ...
        while ($r->have_posts()):
            $r->the_post();
                    ...
                    if (has_post_thumbnail()) {
                        ...
                        $output .= '<h2 class="blog-title"><a href="' . get_permalink() . '">' . get_the_excerpt() . '</a></h2>';
                        $output .= '<div class="blog-categories">' . get_the_title() . '.&nbsp;</div>';
        ...
        while ($r->have_posts()):
            $r->the_post();
                    ...
                    if (has_post_thumbnail()) {
                        ...
                        $output .= '<div class="blog-meta">';
                        $output .= '<h2 class="blog-title"><a href="' . get_permalink() . '">' . get_the_excerpt() . '</a></h2>';
                        $output .= '<div class="blog-categories">' . get_the_title() . '.&nbsp;' . get_the_date() . '</div>';
                        $output .= '<div class="clearboth"></div></div>';
