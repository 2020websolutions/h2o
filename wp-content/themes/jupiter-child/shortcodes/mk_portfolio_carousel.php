...
$image_src = bfi_thumb( $image_src_array[ 0 ], array('width' => $image_src_array[ 1 ]*$image_quality, 'height' => $image_src_array[ 2 ]*$image_quality)); 


$output .= '<li>';
$output .= '<div class="mk-portfolio-carousel-thumb"><img src="'.mk_thumbnail_image_gen($image_src).'" alt="'.get_the_title().'" title="'.get_the_title().'" />';
...
$output .= '<div class="featured-image"><img src="'.mk_thumbnail_image_gen($image_src, 500, 350).'" alt="'.get_the_title().'" title="'.get_the_title().'"  class="item-featured-image" />';
