...
$button = '<a href="'.$url.'" '.$target.' '.$id.' class="mk-button '.$outline_skin.' button-'.$style_id.' '.$animation_css.$text_color.' '.$url_is_smooth.$dimension.'-dimension '.$size.' '.$corner_style.' '.$icon_animate.$visibility.' '.$fullwidth.' '.$el_class.'"><span>'.do_shortcode( strip_tags( $content ) ).$icon.'</span></a>';
