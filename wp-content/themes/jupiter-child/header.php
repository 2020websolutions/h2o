...
?>            
    <head>
        ...
        <meta name="google-site-verification" content="5kh2jD1zMuaQly0Z0aQEDq8RwuZZm92qsGeubB0Ayfw" />
...
})(window,document,'script','dataLayer','GTM-T356Z8');</script>
...
if($toolbar_toggle == 'true') : ?>
  ...
  <?php //}else{ ?>
    <!--<div class="mk-header-toolbar" style="height: <?php //echo $mk_options['header_height']; ?>px; width: 210px; float: right;">-->
  <?php //} ?>
...
<?php /* Header right section elements */ ?>
  ...
  <?php do_shortcode('[xyz-ips snippet="user-logged-in-or-not"]');?>
  <?php 
